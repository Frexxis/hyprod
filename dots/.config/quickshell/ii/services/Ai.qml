...
Singleton {
    ...
    property Component claudeApiStrategy: ClaudeCliStrategy {}
    ...
    property var models: Config.options.policies.ai === 2 ? {} : {
        ...
        "claude-code": aiModelComponent.createObject(this, {
            ...
            "description": Translation.tr("Local CLI | Anthropic's Claude with file/code tools\nUses Claude Code CLI for streaming responses"),
    ...
    function addModel(modelName, data) {
        const existingModel = root.models[modelName];
