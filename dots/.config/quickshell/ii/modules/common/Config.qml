    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject developer: JsonObject {
                property JsonObject git: JsonObject {
                    property string repoPath: "" // empty = auto-detect
                    property int refreshInterval: 5000 // ms, only when Git tab is active
                }

                property JsonObject projects: JsonObject {
                    property int refreshInterval: 15000 // ms, only when Projects tab is active
                ...
                property JsonObject commands: JsonObject {
                    property list<var> commands: [
                        ...
                        },
                        {
                            ...
                            "icon": "settings",
                            "cmd": "xdg-open ~/.config/illogical-impulse/config.json",
                            "terminal": false
                        },
                        {
                            "label": "Open actions folder",
                            "icon": "folder_open",
                            "cmd": "xdg-open ~/.config/illogical-impulse/actions",
                            "terminal": false
                        }
                    ]
                }
                ...
                property JsonObject system: JsonObject {
                    ...
                    property int diskRefreshInterval: 60000 // ms, only when System tab is active
                }
            }
